...
//higher array methods - because they take in another function to tell them what to do
// forEach, map, find, sort, filter, every, some, reduce
const transactions = [1000, -200, 3000, -2500, 600];
const users = ["ade", "john", "ayo", "peter"];
...
//find and filter
//returns the first element that passes a search condition
...
// when using sort with numbers, we need to write a compare function
